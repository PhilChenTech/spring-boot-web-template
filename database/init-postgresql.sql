...
GRANT CONNECT ON DATABASE springboot_template_dev TO springboot_user;
GRANT CONNECT ON DATABASE springboot_template_prod TO springboot_user;
...
-- 完成訊息
\echo '資料庫設定完成！'
\echo '已建立資料庫：springboot_template, springboot_template_dev, springboot_template_prod'
